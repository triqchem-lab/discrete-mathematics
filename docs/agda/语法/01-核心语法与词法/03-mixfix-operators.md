> **混合 fixity 运算符** · `mixfix-operators`
>
> 下划线占位的 mixfix 运算符、precedence、associativity、歧义与作用域、telescope 内的运算符。
>
> 🔗 原文：<https://agda.readthedocs.io/en/latest/language/mixfix-operators.html>
>
> **本项目相关性**：本项目自定义 ≡⟨⟩/∎/_⊕_ 等 mixfix 证明语法；precedence 设置错误是常见 bug 源。

---
# Mixfix Operators[](#mixfix-operators "Link to this heading")
...
* other _sections_ of the full name, for instance leaving one or two underscores:
...
## Precedence[](#precedence "Link to this heading")
...
## Associativity[](#associativity "Link to this heading")
...
## Ambiguity and Scope[](#ambiguity-and-scope "Link to this heading")
...
## Operators in telescopes[](#operators-in-telescopes "Link to this heading")

Agda does not yet support declaring the fixity of operators declared in [telescopes](telescopes.md#telescopes), see Issue #1235 <https://github.com/agda/agda/issues/1235>.
