...
>
> 通过 compiler pragma 与 Haskell/JavaScript 后端的 FFI 绑定外部函数。
>
> 🔗 原文：<https://agda.readthedocs.io/en/latest/language/foreign-function-interface.html>
>
> **本项目相关性**：项目为纯形式化证明轨道，一般不使用 FFI；如需与 Python 工程轨道交互可参考。

---
# Foreign Function Interface[](#foreign-function-interface "Link to this heading")

## [Compiler Pragmas](#id2)[](#compiler-pragmas "Link to this heading")
...
## [Haskell FFI](#id3)[](#haskell-ffi "Link to this heading")

Note

This section applies to the [GHC Backend](https://agda.readthedocs.io/en/latest/tools/compilers.html#ghc-backend).

### [The FOREIGN pragma](#id4)[](#the-foreign-pragma "Link to this heading")
...
### [The COMPILE pragma](#id5)[](#the-compile-pragma "Link to this heading")
...
### [Using Haskell Types from Agda](#id6)[](#using-haskell-types-from-agda "Link to this heading")
...
#### Opaque types[](#opaque-types "Link to this heading")
...
The GHC backend compiles certain Agda [built-in types](built-ins.md#built-ins) to special Haskell types. The mapping between Agda built-in types and Haskell types is as follows:
...
### [Using Haskell functions from Agda](#id7)[](#using-haskell-functions-from-agda "Link to this heading")
...
### [Using Agda functions from Haskell](#id8)[](#using-agda-functions-from-haskell "Link to this heading")
...
### [Polymorphic functions](#id9)[](#polymorphic-functions "Link to this heading")
...
### [Handling typeclass constraints](#id11)[](#handling-typeclass-constraints "Link to this heading")
...
We can then expose `setVisible` as an Agda function taking a Widget [instance argument](instance-arguments.md#instance-arguments):
...
## [JavaScript FFI](#id12)[](#javascript-ffi "Link to this heading")

The [JavaScript backend](https://agda.readthedocs.io/en/latest/tools/compilers.html#javascript-backend) recognizes `COMPILE` pragmas of the following form:
