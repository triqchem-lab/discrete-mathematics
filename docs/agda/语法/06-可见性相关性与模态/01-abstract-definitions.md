> **抽象定义** · `abstract-definitions`
>
> abstract 块内定义的实现细节对外不可见，只能看到其类型签名。
>
> 🔗 原文：<https://agda.readthedocs.io/en/latest/language/abstract-definitions.html>
>
> **本项目相关性**：本项目按范畴分离原则隐藏结构学实现细节时可用；注意 abstract 块内不可随意展开，类型检查期行为需特别留意。

---
# Abstract definitions[](#abstract-definitions "Link to this heading")
...
## Scope of abstraction[](#scope-of-abstraction "Link to this heading")
...
## Abstract definitions with where-blocks[](#abstract-definitions-with-where-blocks "Link to this heading")
