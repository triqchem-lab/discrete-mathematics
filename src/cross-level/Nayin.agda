...
nayinToWuxing DaLinMu      = 5   -- 5 次谐波
nayinToWuxing LuPangTu     = 7
nayinToWuxing JianFengJin  = 9
nayinToWuxing ShanTouHuo   = 11
nayinToWuxing _ = 1  -- 默认基频
...
postulate
  ...
  where
    postulate IsMetaphor : WuXing → Set
...
nayinFingerprintUnique : ∀ (n₁ n₂ : NayinFingerprint) → 
  ...
  n₁ ≡ n₂
nayinFingerprintUnique n₁ n₂ soundEq harmEq = ?
