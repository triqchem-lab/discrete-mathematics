...
import Sovereign.Algebra.Jacobian.jac_Galois      -- σ²=id (心跳)
...
import Sovereign.Algebra.Jacobian.jac_ChainComplex -- 泛链复形
...
import Sovereign.Algebra.Jacobian.jac_WeilRH       -- GF(3)↔GF(9) 对偶
import Sovereign.Algebra.Jacobian.jac_EulerChar    -- ℤ 欧拉 (全局拓扑)
...
import Sovereign.Algebra.Jacobian.jac_Hodge         -- 调和形式 ℋ
import Sovereign.Algebra.Jacobian.jac_HodgeTetra    -- S² 驻波
import Sovereign.Algebra.Jacobian.jac_TorusHodge    -- T² 驻波
import Sovereign.Algebra.Jacobian.jac_KleinHodge    -- Klein 驻波
