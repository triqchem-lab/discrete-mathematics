...
module Sovereign.Algebra.Jacobian.jac_DeligneHodge where
...
open import Sovereign.Algebra.Jacobian.jac_Hodge using (hodge-isomorphism)
open import Sovereign.Algebra.Jacobian.jac_ChainComplex
